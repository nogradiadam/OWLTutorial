...
public class OWLHandler {
	...
	public Map<OWLClass, String> getClassesWithDefinitions (List<OWLClass> classes){
		...
		Map<OWLClass, String> classesWithDefs = new TreeMap <OWLClass, String> ();
...
//							System.out.println(av);
							classesWithDefs.put(cl, av.toString());
						}
					}
				}
			}
